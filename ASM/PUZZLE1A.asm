...
* PUZZLE1A mainline                                                   *
*---------------------------------------------------------------------*
PUZZLE1A CEEENTRY AUTO=WORKDSA_SIZ,MAIN=YES,BASE=(R10,R11)
*
...
*                                  * Was memory successfully allocated?
         IF (CLC,FC(8),NE,=XL8'0000000000000000') THEN
            ...
            B     PUZZLE1A_RET_IMMED * End program
         ENDIF
*
...
*
         ...
         BNE   PUZZLE1A_RET        * If not, get out
*
READNEXT EQU   *
*
...
*
PUZZLE1A_RET EQU   *               * Branch here for normal end
*
...
*
PUZZLE1A_RET_IMMED EQU   *         * Branch here when alloc mem failed
*
...
*
         ...
         MVC   HIGHESTSUM,=A(0)    * Initialize highest sum
*
         MVC   PATHLEN,=A(27)
...
*        Empty record means new elf to come
         ELSE
            IF (CLC,CURRSUM,GT,HIGHESTSUM) THEN * If winning elf so far
               MVC   HIGHESTSUM,CURRSUM * Save this elf's sum
            ENDIF
*
...
*
         L     R15,HIGHESTSUM      * Put highest sum in R15
...
*                                  * Error messages
                             DS    0F
RESULTMSG                    DC    C'HIGHEST SUM WAS ',X'00'
                             DS    0F
