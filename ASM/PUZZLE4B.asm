...
* PUZZLE4B mainline                                                   *
*---------------------------------------------------------------------*
PUZZLE4B CEEENTRY AUTO=WORKDSA_SIZ,MAIN=YES,BASE=(R10,R11)
*
...
*                                  * Was memory successfully allocated?
         IF (CLC,FC(8),NE,=XL8'0000000000000000') THEN
            ...
            B     PUZZLE4B_RET_IMMED * End program
         ENDIF
*
...
*
         ...
         BNE   PUZZLE4B_RET        * If not, get out
*
READNEXT EQU   *
*
...
*
PUZZLE4B_RET EQU   *               * Branch here for normal end
*
...
*
PUZZLE4B_RET_IMMED EQU   *         * Branch here when alloc mem failed
*
...
*
            ENDDO
*
*           If range 1 and 2 overlap
            IF (CLC,R1LOW,LE,R2HIGH),AND,                              X
               (CLC,R1HIGH,GE,R2LOW) THEN
...
*                                  * Error messages
                             DS    0F
RESULTMSG                    DC    C'OVERLAP COUNT ',X'00'
                             DS    0F
